...
- M13 Phase 5B2 Fixture 0.3.0 Bootstrap Defect & 0.3.1 Hotfix: WordPress.com caught `Uncaught Error: Class "WC_Payment_Gateway" not found` on 0.3.0 upload; plugin was safely deactivated without affecting Core rc.9, WooCommerce, or site health. Upgraded `statement-integration-fixtures` to `0.3.1` (`dist/statement-integration-fixtures-0.3.1.zip`, SHA-256: `484244bc2ee698ad8425cbb95a0aca7e7b852ad2305a3a27439e2d676f45bea2`) using lazy `woocommerce_payment_gateways` loading with duplicate prevention, hardened SKU + Product ID availability validation, order scope line-item revalidation, and single stock deduction via WooCommerce core `payment_complete()`.
