...
test('M15: Theme 0.13.0-rc.24 metadata and file structure', () => {
...
test('M15: Package Theme 0.13.0-rc.24 and Client Demo 0.2.7', () => {
  const themePkg = packageTheme('0.13.0-rc.24');
  assert.equal(themePkg.version, '0.13.0-rc.24');
