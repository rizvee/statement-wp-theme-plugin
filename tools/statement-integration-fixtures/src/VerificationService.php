	...
	public static function verify(): array {
		try {
			...
			foreach ( $product_ids as $pid ) {
				...
				// Exercise WooCommerce's real public runtime API, which applies Statement Core's woocommerce_is_purchasable filter
			...
			return array( 'seeded' => false, 'error' => true, 'message' => 'Verification assertion failed: ' . $e->getMessage() );
		}
	}
}
