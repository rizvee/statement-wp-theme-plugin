...
- Current Core Candidate: `0.13.0-rc.8`
- Historical Candidates: `0.13.0-rc.1`, `0.13.0-rc.2`, `0.13.0-rc.3`, `0.13.0-rc.4`, `0.13.0-rc.5`, `0.13.0-rc.6`, `0.13.0-rc.7`
...
| `M13-ISSUE-08` | `M13-5B2-03` | Anonymous Private Product Boundary | Private PDP body and public Store API expose no PRIVATE_ACCESS product facts | rc.7-target retest remained unchanged; active live Core version was not HTTP-observable | CORE / PRIVACY | HIGH | `HEAD` | rc.8 | Pending Atomic Retest | FIXED LOCALLY IN RC.8 |
...
### `M13-EVIDENCE-10`: Phase 5B2 rc.7-Target Retest and rc.8 Hardening

- Live Core version: `VERSION_OBSERVABILITY_UNKNOWN`; no public response or header exposed `0.13.0-rc.7`.
